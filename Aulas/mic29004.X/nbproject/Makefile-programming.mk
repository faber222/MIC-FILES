...
SOURCEFILES_QUOTED_IF_SPACED=Aula03_11.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Aula03_11.obj
POSSIBLE_DEPFILES=${OBJECTDIR}/Aula03_11.obj.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Aula03_11.obj

# Source Files
SOURCEFILES=Aula03_11.asm
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Aula03_11.obj: Aula03_11.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Aula03_11.obj 
	${MP_AS}  -fI -W+ie ${PACK_ASSEMBLER_OPTIONS} -d dist/${CND_CONF}/${IMAGE_TYPE}/mic29004.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  -m dist/${CND_CONF}/${IMAGE_TYPE}/mic29004.X.${IMAGE_TYPE}.map  -S dist/${CND_CONF}/${IMAGE_TYPE}/mic29004.X.${IMAGE_TYPE}.tmp Aula03_11.asm
else
${OBJECTDIR}/Aula03_11.obj: Aula03_11.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Aula03_11.obj 
	${MP_AS}  -fI -W+ie ${PACK_ASSEMBLER_OPTIONS} -d dist/${CND_CONF}/${IMAGE_TYPE}/mic29004.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  -S dist/${CND_CONF}/${IMAGE_TYPE}/mic29004.X.${IMAGE_TYPE}.tmp  -o dist/${CND_CONF}/${IMAGE_TYPE}/mic29004.X.${IMAGE_TYPE}.hex  -m dist/${CND_CONF}/${IMAGE_TYPE}/mic29004.X.${IMAGE_TYPE}.map Aula03_11.asm
endif
